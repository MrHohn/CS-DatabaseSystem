...
public class PNLJoinTest {
	...
	System.out.println("PNLJoinTest Relation 1 is  "+ table1.numPages() +"  pages");
	...
	System.out.println("PNLJoinTest Relation 2 is  "+ table2.numPages() +"  pages");
    ...
    @Test public void testSingleMatch()
            throws IOException, DbException, TransactionAbortedException {
	System.out.println("--------------------------------------------");
	System.out.println("PNLJoinTest - Test Single Match");
    ...
    @Test public void testNoMatch()
            throws IOException, DbException, TransactionAbortedException {
	System.out.println("--------------------------------------------");
	System.out.println("PNLJoinTest - Test No Match");
    ...
    @Test public void testMultipleMatch()
            throws IOException, DbException, TransactionAbortedException {
	System.out.println("--------------------------------------------");
	System.out.println("PNLJoinTest - Test Multiple Matches");
    ...
    @Test public void testLargeOuter()
          throws IOException, DbException, TransactionAbortedException {
    	System.out.println("--------------------------------------------");
    	System.out.println("PNLJoinTest - Test Large Outer");
    ...
    @Test public void testLargeInner()
        throws IOException, DbException, TransactionAbortedException {
    	System.out.println("--------------------------------------------");
    	System.out.println("PNLJoinTest - Test Large Inner");
    ...
    @Test public void testLargeOuterInner()
          throws IOException, DbException, TransactionAbortedException {
    	System.out.println("--------------------------------------------");
    	System.out.println("PNLJoinTest - Test Large Outer and Inter");
    ...
    public static junit.framework.Test suite() {
        return new junit.framework.JUnit4TestAdapter(PNLJoinTest.class);
    }
}
